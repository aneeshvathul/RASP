...
public class OmeroExtension implements QuPathExtension, GitHubProject {
	...
	public void installExtension(QuPathGUI qupath) {
		...
		var actionSendObjects = ActionTools.createAction(new OmeroWritePathObjectsCommand(qupath), "Send my annotations to OMERO");
		var actionPullObjects = ActionTools.createAction(new OmeroPullAnnotations(qupath), "Pull annotations from OMERO");
		// var actionShowSelectionDialog = ActionTools.createAction(new OmeroShowPullAnnotationsDialog(qupath), "Show annotation pulling options");
...
//		browseServerMenu.disableProperty().bind(qupath.projectProperty().isNull());
		...
		actionPullObjects.disabledProperty().bind(qupath.imageDataProperty().isNull());
		// actionShowSelectionDialog.disabledProperty().bind(qupath.imageDataProperty().isNull());
